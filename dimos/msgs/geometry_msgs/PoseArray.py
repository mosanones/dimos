...
class PoseArray:
    """Array of poses with header for reference frame and timestamp.

    Used for representing multiple candidate positions such as grasp poses,
    particle filter samples, or waypoints.
    """
